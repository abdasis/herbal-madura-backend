    ...
    <nav class="navbar navbar-expand-lg navbar-landing navbar-light border-bottom border-light shadow-none fixed-top is-sticky" id="navbar">
        <div class="container">
            <a class="navbar-brand" href="{{url('/')}}">
                <img src="{{asset('assets/images/logo-dark.png')}}" class="card-logo card-logo-dark" alt="logo dark" height="35">
                <img src="{{asset('assets/images/logo-light.png')}}" class="card-logo card-logo-light" alt="logo light" height="35">
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                @if(auth()->check())
                    <div class="dropdown nav-profile d-flex align-items-center gap-2">
                        ...
                        <ul class="dropdown-menu border-light shadow-sm  mt-4 px-2" aria-labelledby="navbarDropdown">
                ...
                @else
                    <a href="{{route('login')}}" class="btn fs-14 px-3 btn-success btn-border btn-sm d-flex justify-content-center align-items-center">
                        Login / Register
                    </a>
                @endif
            </div>
