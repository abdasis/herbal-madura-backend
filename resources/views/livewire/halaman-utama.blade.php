<div>
    ...
    <div class="container" style="min-height: 100vh">
        <div class="jumbotron hero-halaman-utama rounded-full">
            <div class="container">
                <h1 class="display-4 text-bold text-black">Ensiklopedia Herbal</h1>
                <p class="lead">Selamat datang di web ensiklopedia herbal, situs web yang menyediakan informasi tanaman
                    herbal</p>
            </div>
        </div>
                        ...
                        <div class="card-body">
                            <div class="card-title">
                                <a class="text-orange" href="{{ route('tanaman.baca', $tanaman_detail->slug) }}">
                                    <h5 class="title-tanaman text-bold">{{ $tanaman_detail->nama_tanaman }} (Latin:
                            ...
                            <div class="card-text">
                                <div class="meta-artikel">
                                    ...
                                    <div class="badge badge-light p-1">Ditinjau oleh:
                                        <span>{{ $tanaman_detail->diverifikasi->name ?? 'Belum diverifikasi' }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
