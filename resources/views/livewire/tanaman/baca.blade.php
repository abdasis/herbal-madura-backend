                        ...
                        @auth()
                            <div class="reaction-item">
                                <ul class="d-flex list-unstyled gap-2">
                                    <li wire:click="suka"
                                        class="d-flex align-items-center {{ \Reaction::has($tanaman, auth()->user(), 'heart') ? 'liked' : 'not-liked' }} mb-0 cursor-pointer gap-1">
                                        <i
                                    ...
                                    <li wire:click="jempol"
                                        class="d-flex align-items-center {{ \Reaction::has($tanaman, auth()->user(), 'person_raising_hand') ? 'liked' : 'not-liked' }} mb-0 cursor-pointer gap-1">
                                        <i
