        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card shadow-none border-0">
                    <div class="card-body">
                        <div class="card-title"><h5 class="text-bold mb-3">Update Artikel | <span class="text-danger">{{$nama_tanaman}}</span></h5></div>
                        ...
                        <div class="form-group">
                            <div class="editor-content" wire:ignore>
                                <textarea name="" wire:model="diskripsi" class="form-control" placeholder="Tulis lengkap diskripsi tanaman" id="manfaat" cols="30" rows="10">
