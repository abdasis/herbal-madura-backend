<div>
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            ...
                            <h4 class="mb-0"><span class="counter-value"
                                    data-target="{{ $popular_perminggu->count() }}">{{ $popular_perminggu->count() }}</span>
                            </h4>
                        </div>
                    </div>
                </div><!-- end card body -->
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            ...
                            <h4 class="mb-0"><span class="counter-value"
                                    data-target="{{ $popular_perbulan->count() }}">{{ $popular_perbulan->count() }}</span>
                            </h4>
                        </div>
                    </div>
                </div><!-- end card body -->
    ...
    <div class="card">
        ...
        <div class="card-body">
            <table class="table-card table-sm table">
