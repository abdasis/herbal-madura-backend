...
namespace CyrildeWit\EloquentViewable {
     ...
     * @see \CyrildeWit\EloquentViewable\Views::period
     * @method static \CyrildeWit\EloquentViewable\Contracts\Views period(\CyrildeWit\EloquentViewable\Support\Period|null $period)
     * @see \CyrildeWit\EloquentViewable\Views::count
     * @method static int count()
     * @see \CyrildeWit\EloquentViewable\Views::destroy
     * @method static void destroy()
     * @see \CyrildeWit\EloquentViewable\Views::collection
     * @method static \CyrildeWit\EloquentViewable\Contracts\Views collection(null|string $name)
     * @see \CyrildeWit\EloquentViewable\Views::remember
     * @method static \CyrildeWit\EloquentViewable\Contracts\Views remember(\DateTimeInterface|int|null $lifetime = null)
     * @see \CyrildeWit\EloquentViewable\Views::useVisitor
     * @method static \CyrildeWit\EloquentViewable\Contracts\Views useVisitor(\CyrildeWit\EloquentViewable\Contracts\Visitor $visitor)
     * @see \Illuminate\Support\Traits\Macroable::mixin
     * @method static void mixin(object $mixin, bool $replace = true)
     * @see \Illuminate\Support\Traits\Macroable::hasMacro
     * @method static bool hasMacro(string $name)
     * @see \CyrildeWit\EloquentViewable\Views::forViewable
     * @method static \CyrildeWit\EloquentViewable\Contracts\Views forViewable(\CyrildeWit\EloquentViewable\Contracts\Viewable $viewable)
     * @see \CyrildeWit\EloquentViewable\Views::unique
     * @method static \CyrildeWit\EloquentViewable\Contracts\Views unique(bool $state = true)
     * @see \CyrildeWit\EloquentViewable\Views::record
     * @method static bool record()
     * @see \CyrildeWit\EloquentViewable\Views::cooldown
     * @method static \CyrildeWit\EloquentViewable\Contracts\Views cooldown(\DateTimeInterface|int|null $cooldown)
     */
    class ViewsFacade {}
}
